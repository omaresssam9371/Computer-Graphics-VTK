...
function App() {
  ...
  return (
    <div className="App">
      <header className="App-header">
        <p>
          Computer Graphics Vtk.js
        </p>
        {/* <img src="medical-technology-room.jpg" alt="VTK" width="500" height="600"></img> */}
        <button fontSize="inherit" onClick={chestclick} >Chest</button>
        <button fontSize="inherit" onClick={headclick}  >Skull</button>
